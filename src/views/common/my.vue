  ...
  <div>
      ...
      <el-row>
        ...
        <el-col :span="18">
          <div style="margin-top:10px;">
            <p>
              <span style="font-size:18px;">真实姓名</span>
            </p>
            <p>
              <span style="font-size:14px;">所属机构所属机构所属机构</span>
            </p>
          </div>
        </el-col>
      </el-row>
    ...
    <div style="border-bottom:1px solid #f2f2f2;">
      <mt-cell title="E-mail">
        <span>123456@126.com</span>
        <i slot="icon" class="el-icon-message" style="color:#E6A23C;"></i>
      </mt-cell>
    </div>
    <div style="margin-top:20px;padding:10px 20px;">
      <span style="float:right;">
        <el-button type="primary" icon="el-icon-edit-outline" @click.native="updatePasswordHandle()">修改密码</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 退出
      logoutHandle () {
        this.MessageBox.confirm('确定退出?', '提示').then(() => {
          this.$http({
